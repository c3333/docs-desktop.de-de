...
---
# <a name="data-binding-overview-wpf-net"></a>Übersicht über die Datenbindung (WPF .NET)
...
![Standardvalidierungsfehler bei Datenbindung](./media/data-binding-overview/demo-validation-price.png "DataBindingDemo_ValidationDefault")
