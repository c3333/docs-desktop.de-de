...
XAML unterstützt eine Flags-Verwendung für Enumerationen mit <xref:System.FlagsAttribute> angewendeten. Weitere Informationen finden Sie [in der XAML-Syntax im Detail](../framework/wpf/advanced/xaml-syntax-in-detail.md). (Die[XAML-Syntax wird im Detail](../framework/wpf/advanced/xaml-syntax-in-detail.md) für die WPF-Zielgruppe geschrieben, aber die meisten Informationen in diesem Thema sind für XAML relevant, das nicht spezifisch für ein bestimmtes implementierungsframework ist.)
...
## <a name="xaml-related-clr-attributes"></a>XAML-Related CLR-Attribute
