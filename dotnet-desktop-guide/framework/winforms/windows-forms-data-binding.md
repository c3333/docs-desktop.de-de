...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Weitere Informationen finden Sie auch unter [Schnittstellen im Zusammenhang mit der Datenbindung](interfaces-related-to-data-binding.md), Gewusst [wie: Navigieren in Daten in Windows Forms](how-to-navigate-data-in-windows-forms.md)und Gewusst [wie: Erstellen eines Simple-Bound Steuer Elements in einem Windows Form](how-to-create-a-simple-bound-control-on-a-windows-form.md).  
