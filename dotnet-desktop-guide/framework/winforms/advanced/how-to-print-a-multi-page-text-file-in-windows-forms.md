...
- Informationen zum aufbauen dieses Beispiels über die Befehlszeile für Visual Basic oder Visual c# finden Sie unter [Building from the Command Line](/dotnet/visual-basic/reference/command-line-compiler/building-from-the-command-line) or [Command-Line Building with #b0 ](/dotnet/csharp/language-reference/compiler-options/command-line-building-with-csc-exe). Sie können dieses Beispiel auch in Visual Studio erstellen, indem Sie den Code in ein neues Projekt einfügen.  
