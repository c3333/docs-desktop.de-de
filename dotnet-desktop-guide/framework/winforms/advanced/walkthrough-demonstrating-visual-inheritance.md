...
1. Wechseln Sie zur Entwurfs Ansicht, indem Sie über dem Code-Editor auf die Registerkarte **Form1. vb [Entwurf], Form1.cs [Entwurf] oder Form1.jsl [Entwurf]** klicken oder indem Sie F7 drücken.
...
3. Belassen Sie den Standardnamen von, `Form2` und klicken Sie dann auf **Hinzufügen**.
