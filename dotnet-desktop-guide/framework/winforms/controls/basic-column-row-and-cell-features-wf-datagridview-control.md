...
Viele grundlegende Verhalten von `DataGridView` Zellen, Zeilen und Spalten können durch Festlegen einzelner Eigenschaften geändert werden. In den Themen in diesem Abschnitt werden einige der am häufigsten verwendeten Funktionen beschrieben.  
