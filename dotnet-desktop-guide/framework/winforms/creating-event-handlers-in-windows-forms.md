...
## <a name="in-this-section"></a>In diesem Abschnitt
 ...
 Gewusst [wie: Erstellen von Ereignis Handlern mithilfe des Designers](/previous-versions/visualstudio/visual-studio-2010/zwwsdtbk(v=vs.100)) Beschreibt, wie die Windows Forms-Designer zum Erstellen von Ereignis Handlern verwendet wird.

## <a name="related-sections"></a>Verwandte Abschnitte

 [Fall](/dotnet/standard/events/index)\
