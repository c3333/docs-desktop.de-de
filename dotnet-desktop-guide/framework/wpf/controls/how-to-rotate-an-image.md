...
In diesem Beispiel wird gezeigt, wie ein Bild um 90 Grad gedreht wird, indem die-Eigenschaft eines verwendet wird <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> <xref:System.Windows.Media.Imaging.BitmapImage> .  
