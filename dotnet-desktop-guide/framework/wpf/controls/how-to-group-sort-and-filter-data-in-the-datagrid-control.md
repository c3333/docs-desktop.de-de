...
2. Erstellen Sie in XAML eine Instanz der Collection-Klasse, und legen Sie die [x:Key-Direktive](/dotnet/desktop-wpf/xaml-services/xkey-directive)fest.

3. Erstellen Sie in XAML eine Instanz der- <xref:System.Windows.Data.CollectionViewSource> Klasse, legen Sie die [x:Key-Direktive](/dotnet/desktop-wpf/xaml-services/xkey-directive)fest, und legen Sie die Instanz der Auflistungs Klasse als fest <xref:System.Windows.Data.CollectionViewSource.Source%2A> .
