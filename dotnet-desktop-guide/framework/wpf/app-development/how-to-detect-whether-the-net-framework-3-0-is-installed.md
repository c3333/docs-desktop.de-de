...
> [!NOTE]
> Ausführlichere Informationen zum Installieren, bereitstellen und Ermitteln des Microsoft .NET Frameworks finden Sie unter Bereitstellen [Microsoft .NET Framework-Version 3,0](/previous-versions/dotnet/articles/aa480198(v=msdn.10)).  
  
<a name="content_expiration"></a>

## <a name="detect-the-net-clr-user-agent-string"></a>Erkennen der User-Agent Zeichenfolge ".NET CLR"  
