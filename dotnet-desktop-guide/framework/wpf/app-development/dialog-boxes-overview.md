...
> [!NOTE]
> Sie müssen einen Besitzer angeben, um die Automatisierung der Benutzeroberfläche (UI) für Dialogfelder zu unterstützen (siehe [Übersicht über](/dotnet/framework/ui-automation/ui-automation-overview)die Benutzeroberflächen Automatisierung).
