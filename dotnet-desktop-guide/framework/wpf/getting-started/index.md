...
|Neu bei .NET?|[Übersicht über .NET Framework](/dotnet/framework/get-started/overview)<br /><br /> [Erste Schritte mit Visual C# und Visual Basic](/visualstudio/ide/quickstart-visual-basic-console)|  
|Weitere Informationen über WPF...|[Einführung in WPF in Visual Studio](introduction-to-wpf-in-vs.md)<br /><br /> [Übersicht über XAML (WPF)](/dotnet/desktop-wpf/fundamentals/xaml)<br /><br /> [Steuerelemente](../controls/index.md)<br /><br /> [Übersicht zur Datenbindung](/dotnet/desktop-wpf/data/data-binding-overview)|  
