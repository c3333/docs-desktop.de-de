...
ms.locfileid: "96977623"
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="eb4f2-102">Gewusst wie: Konvertieren einer BitmapSource in ein indiziertes Pixelformat</span><span class="sxs-lookup"><span data-stu-id="eb4f2-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="eb4f2-103">In diesem Beispiel wird gezeigt, wie ein <xref:System.Windows.Media.Imaging.BitmapSource> in ein indiziertes Pixel Format konvertiert wird.</span><span class="sxs-lookup"><span data-stu-id="eb4f2-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="eb4f2-104">Beispiel</span><span class="sxs-lookup"><span data-stu-id="eb4f2-104">Example</span></span>  
